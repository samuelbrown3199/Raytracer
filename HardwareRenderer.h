...
public:
	...
	void SplitBVHNode(std::vector<GPUTriangle>& triangles, std::vector<GPUBVHNode>& outNodes, GPUBVHNode& node);
	float EvaluateSplitCost(std::vector<GPUTriangle>& triangles, std::vector<GPUBVHNode>& outNodes, GPUBVHNode& node, int axis, float pos);
